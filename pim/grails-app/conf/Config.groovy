...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'forgebiz.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'forgebiz.UserRole'
grails.plugin.springsecurity.authority.className = 'forgebiz.Role'
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
	'/upload/handle': ['ROLE_ADMIN'],
	'/user/**': ['ROLE_ADMIN'],
	'/role/**': ['ROLE_ADMIN'],
	'/quartz/**': ['ROLE_ADMIN'],
	'/securityInfo/**': ['ROLE_ADMIN'],
	'/restfulapi/**':     ['permitAll'],
	'/':                              ['permitAll'],
	'/index':                         ['permitAll'],
	'/index.gsp':                     ['permitAll'],
	'/assets/**':                     ['permitAll'],
